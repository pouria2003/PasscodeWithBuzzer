...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  for(int i = 0; i < 4; ++i)
		  display_digit(digits[i], i, selected_digit == i);
//
//	  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_8, HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_11));
//	  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_9, HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_10));
